...
public class Field {
    ...
    private static HashMap<String, Type> sTypeJsonNames = new HashMap<String, Type>();
    private static HashMap<String, OnDeleteAction> sOnDeleteActionJsonNames = new HashMap<String, OnDeleteAction>();
